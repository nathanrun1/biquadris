...
class Level {
    ...
    public:
        Level(Board& myBoard, std::mt19937& randGen, std::string seqFile, bool isRandom);
...
class Level_1: public Level {
    public:
        Level_1(Board* myBoard, std::string seqFile, std::mt19937 seed, bool isRandom);
...
class Level_2: public Level {
    public:
        Level_2(Board* myBoard, std::string seqFile, std::mt19937 seed, bool isRandom);
...
class Level_3: public Level {
    public:
        Level_3(Board* myBoard, std::string seqFile, std::mt19937 seed, bool isRandom);
...
class Level_4: public Level {
        Level_4(Board* myBoard, std::string seqFile, std::mt19937 seed, bool isRandom);
