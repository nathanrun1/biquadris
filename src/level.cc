...
std::shared_ptr<BlockShape> Level::stringToBlock(const std::string s)  const {
    if (s == "I") return std::make_unique<I_Shape>();
    else if (s == "J") return std::make_unique<J_Shape>();
    else if (s == "L") return std::make_unique<L_Shape>();
    else if (s == "O") return std::make_unique<O_Shape>();
    else if (s == "S") return std::make_unique<S_Shape>();
    else if (s == "Z") return std::make_unique<Z_Shape>();
    else if (s == "T") return std::make_unique<T_Shape>();
...
std::shared_ptr<BlockShape> Level_1::getNext() {
    ...
    int randNum = seed() % 12;
    if (randNum == 0 || randNum == 1)         return std::make_unique<I_Shape>();
    else if (randNum == 2 || randNum == 3)    return std::make_unique<J_Shape>();
    else if (randNum == 4 || randNum == 5)    return std::make_unique<L_Shape>();
    else if (randNum == 6 || randNum == 7)    return std::make_unique<O_Shape>();
    else if (randNum == 8)                    return std::make_unique<S_Shape>();
    else if (randNum == 9)                    return std::make_unique<Z_Shape>();
    else if (randNum == 10 || randNum == 11)  return std::make_unique<T_Shape>();
}
...
std::shared_ptr<BlockShape> Level_2::getNext() {
    ...
    int randNum = seed() % 7;
    if (randNum == 0)         return std::make_unique<I_Shape>();
    else if (randNum == 1)    return std::make_unique<J_Shape>();
    else if (randNum == 2)    return std::make_unique<L_Shape>();
    else if (randNum == 3)    return std::make_unique<O_Shape>();
    else if (randNum == 4)    return std::make_unique<S_Shape>();
    else if (randNum == 5)    return std::make_unique<Z_Shape>();
    else if (randNum == 6)    return std::make_unique<T_Shape>();
}
...
std::shared_ptr<BlockShape> Level_3::getNext() {
    ...
    else if (randNum == 4 || randNum == 5)   return std::make_unique<S_Shape>();
    else if (randNum == 6 || randNum == 7)   return std::make_unique<Z_Shape>();
    else if (randNum == 8)                   return std::make_unique<T_Shape>();
}
